...
import argparse
import torch
from src.datasets.synthetic_config import CLASS_NAMES, CLASS_COLORS, ID2TRAINID, SYNTHETIC_NUM_CLASSES
...
def predict(filepath, checkpoint):
    ...
    output_filename = filepath.replace('.las', f"_predicted_{checkpoint_identifier[0]}_t{checkpoint_identifier[2]}.las")
